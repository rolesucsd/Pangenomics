...
write.table(df_c[df_c$Contamination < 5,1], paste(output,"_filter.txt",sep=""), quote=FALSE,row.names = FALSE,col.names = FALSE,sep="\t")
write.table(df_c[df_c$Contamination >= 5,1], paste(output,"_bin.txt",sep=""), quote=FALSE,row.names = FALSE,col.names = FALSE,sep="\t")
